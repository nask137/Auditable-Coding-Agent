...
public record NodeExecutionResult(
    ...
    public static NodeExecutionResult running(String summary, Map<String, Object> payload) {
        return new NodeExecutionResult("RUNNING", summary, payload == null ? Map.of() : payload, null, null, null, null);
    }
    ...
    public static NodeExecutionResult blocked(String summary) {
        return new NodeExecutionResult("BLOCKED", summary, Map.of(), null, null, null, null);
    }
    ...
    public static NodeExecutionResult waitingApproval(String summary, Map<String, Object> payload) {
        return new NodeExecutionResult("WAITING_APPROVAL", summary, payload == null ? Map.of() : payload, null, null, null, null);
    }
    ...
    public static NodeExecutionResult waitingUserInput(String summary, Map<String, Object> payload) {
        return new NodeExecutionResult("WAITING_USER_INPUT", summary, payload == null ? Map.of() : payload, null, null, null, null);
    }
